...
\begin{widetext}
    ...
    Energy extracted by Bob for $H^{(2)}$ for $\sigma_A = X_0$ (\textbf{\textcolor{BrickRed}{TODO: Find a better way to show it, maybe in appendix - but what about consistency with other expressions shown in paper?}})
\end{widetext}
