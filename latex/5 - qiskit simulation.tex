...
\begin{figure*}[t!]
    ...
    \subfloat[Charge teleportation]{
        \includegraphics[width=0.45\textwidth]{plots/qiskit/real hw/real_hw_charge_vs_J.png}
    }
    \hfill
    \subfloat[Energy teleportation]{
        \includegraphics[width=0.45\textwidth]{plots/qiskit/real hw/real_hw_energy_vs_J.png}
    }
