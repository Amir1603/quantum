...
\begin{figure}[ht]
    ...
    \caption{\( Q_B \) vs. \( J \), for the nearest-neighbors model \( H^{(2)} \), with \( h=1 \) and \( \sigma_A = X_0 \).}
    \label{fig:nn_x_vs_j}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{\( Q_B \) vs. \( J \), for the nearest-neighbors model \( H^{(2)} \), with \( h=1 \) and \( \sigma_A = Y_0 \).}
    \label{fig:nn_y_vs_j}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \subfloat[\( N = 2 \)]{
        \includegraphics[width=0.45\columnwidth]{plots/numerical/NearestNeighbors/both/N2_charge_vs_J.png}
    }
    \hfill
    \subfloat[\( N = 3 \)]{
        \includegraphics[width=0.45\columnwidth]{plots/numerical/NearestNeighbors/both/N3_charge_vs_J.png}
    }

    \medskip
    
    \subfloat[\( N = 4 \)]{
        \includegraphics[width=0.45\columnwidth]{plots/numerical/NearestNeighbors/both/N4_charge_vs_J.png}
    }
    \caption{Comparison of \( Q_B \) vs. \( J \) under \( \sigma_A = X_0 \) and \( Y_0 \).}
