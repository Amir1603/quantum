...
\begin{figure*}[tb!]
    ...
    \begin{subfigure}{0.24\textwidth}
        ...
        \caption{\( N = 4 \)}
    \end{subfigure}
    \caption{Bob’s extracted values for charge vs. the coupling \( J \), for \( H^{(1)} \), with fixed \( h=1 \) and \( \sigma_A = X_0 \).}
...
\begin{figure*}[tb!]
    ...
    \begin{subfigure}{0.33\textwidth}
        ...
        \caption{\( N = 4 \)}
    \end{subfigure}
    \caption{Bob’s extracted values for charge vs. the coupling \( J \), for \( H^{(2)} \), with fixed \( h=1 \) and \( \sigma_A = X_0 \).}
    \label{fig:nn_x_vs_j}
\end{figure*}
...
\begin{figure*}[tb!]
    ...
    \begin{subfigure}{0.33\textwidth}
        ...
        \caption{\( N = 4 \)}
    \end{subfigure}
    \caption{Bob’s extracted values for charge vs. the coupling \( J \), for \( H^{(2)} \), with fixed \( h=1 \) and \( \sigma_A = Y_0 \).}
    \label{fig:nn_y_vs_j}
\end{figure*}
